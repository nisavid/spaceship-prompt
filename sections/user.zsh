...
SPACESHIP_USER_DIVIDER="${SPACESHIP_USER_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_USER_COLOR="${SPACESHIP_USER_COLOR="yellow"}"
SPACESHIP_USER_COLOR_ROOT="${SPACESHIP_USER_COLOR_ROOT="red"}"
SPACESHIP_USER_SYMBOL="${SPACESHIP_USER_SYMBOL="with"}"
SPACESHIP_USER_PREFIX="${SPACESHIP_USER_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_USER_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
