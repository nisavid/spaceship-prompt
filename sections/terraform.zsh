...
SPACESHIP_TERRAFORM_DIVIDER="${SPACESHIP_TERRAFORM_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_TERRAFORM_COLOR="${SPACESHIP_TERRAFORM_COLOR="105"}"
SPACESHIP_TERRAFORM_SYMBOL="${SPACESHIP_TERRAFORM_SYMBOL="🛠 "}"
SPACESHIP_TERRAFORM_PREFIX="${SPACESHIP_TERRAFORM_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_TERRAFORM_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
