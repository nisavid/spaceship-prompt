...
SPACESHIP_TIME_DIVIDER="${SPACESHIP_TIME_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_TIME_COLOR="${SPACESHIP_TIME_COLOR="yellow"}"
SPACESHIP_TIME_SYMBOL="${SPACESHIP_TIME_SYMBOL="at"}"
SPACESHIP_TIME_PREFIX="${SPACESHIP_TIME_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_TIME_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
