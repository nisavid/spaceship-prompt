...
SPACESHIP_RUST_DIVIDER="${SPACESHIP_RUST_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_RUST_COLOR="${SPACESHIP_RUST_COLOR="red"}"
SPACESHIP_RUST_SYMBOL="${SPACESHIP_RUST_SYMBOL="𝗥"}"
SPACESHIP_RUST_PREFIX="${SPACESHIP_RUST_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_RUST_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
