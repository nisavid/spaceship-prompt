...
SPACESHIP_HOST_DIVIDER="${SPACESHIP_HOST_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_HOST_COLOR="${SPACESHIP_HOST_COLOR="blue"}"
SPACESHIP_HOST_COLOR_SSH="${SPACESHIP_HOST_COLOR_SSH="green"}"
SPACESHIP_HOST_SYMBOL="${SPACESHIP_HOST_SYMBOL="at"}"
SPACESHIP_HOST_PREFIX="${SPACESHIP_HOST_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_HOST_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
