...
SPACESHIP_PACKAGE_DIVIDER="${SPACESHIP_PACKAGE_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_PACKAGE_COLOR="${SPACESHIP_PACKAGE_COLOR="red"}"
SPACESHIP_PACKAGE_SYMBOL="${SPACESHIP_PACKAGE_SYMBOL="📦"}"
SPACESHIP_PACKAGE_PREFIX="${SPACESHIP_PACKAGE_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_PACKAGE_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
