...
SPACESHIP_ELIXIR_DIVIDER="${SPACESHIP_ELIXIR_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_ELIXIR_COLOR="${SPACESHIP_ELIXIR_COLOR="magenta"}"
SPACESHIP_ELIXIR_SYMBOL="${SPACESHIP_ELIXIR_SYMBOL="💧"}"
SPACESHIP_ELIXIR_PREFIX="${SPACESHIP_ELIXIR_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_ELIXIR_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
