...
SPACESHIP_EMBER_DIVIDER="${SPACESHIP_EMBER_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_EMBER_COLOR="${SPACESHIP_EMBER_COLOR="210"}"
SPACESHIP_EMBER_SYMBOL="${SPACESHIP_EMBER_SYMBOL="🐹"}"
SPACESHIP_EMBER_PREFIX="${SPACESHIP_EMBER_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_EMBER_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
