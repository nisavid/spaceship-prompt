...
SPACESHIP_NODE_DIVIDER="${SPACESHIP_NODE_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_NODE_COLOR="${SPACESHIP_NODE_COLOR="green"}"
SPACESHIP_NODE_SYMBOL="${SPACESHIP_NODE_SYMBOL="⬢"}"
SPACESHIP_NODE_PREFIX="${SPACESHIP_NODE_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_NODE_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
