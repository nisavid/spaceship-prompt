...
SPACESHIP_HASKELL_DIVIDER="${SPACESHIP_HASKELL_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_HASKELL_COLOR="${SPACESHIP_HASKELL_COLOR="red"}"
SPACESHIP_HASKELL_SYMBOL="${SPACESHIP_HASKELL_SYMBOL="λ"}"
SPACESHIP_HASKELL_PREFIX="${SPACESHIP_HASKELL_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_HASKELL_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
