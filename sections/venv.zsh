...
SPACESHIP_VENV_DIVIDER="${SPACESHIP_VENV_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_VENV_COLOR="${SPACESHIP_VENV_COLOR="blue"}"
SPACESHIP_VENV_SYMBOL="${SPACESHIP_VENV_SYMBOL=""}"
SPACESHIP_VENV_PREFIX="${SPACESHIP_VENV_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_VENV_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
