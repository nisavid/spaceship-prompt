...
SPACESHIP_XCODE_DIVIDER="${SPACESHIP_XCODE_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_XCODE_COLOR="${SPACESHIP_XCODE_COLOR="blue"}"
SPACESHIP_XCODE_SYMBOL="${SPACESHIP_XCODE_SYMBOL="🛠 "}"
SPACESHIP_XCODE_PREFIX="${SPACESHIP_XCODE_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_XCODE_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
