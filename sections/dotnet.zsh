...
SPACESHIP_DOTNET_DIVIDER="${SPACESHIP_DOTNET_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_DOTNET_COLOR="${SPACESHIP_DOTNET_COLOR="128"}"
SPACESHIP_DOTNET_SYMBOL="${SPACESHIP_DOTNET_SYMBOL=".NET"}"
SPACESHIP_DOTNET_PREFIX="${SPACESHIP_DOTNET_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_DOTNET_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
