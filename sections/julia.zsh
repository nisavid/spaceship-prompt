...
SPACESHIP_JULIA_DIVIDER="${SPACESHIP_JULIA_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_JULIA_COLOR="${SPACESHIP_JULIA_COLOR="green"}"
SPACESHIP_JULIA_SYMBOL="${SPACESHIP_JULIA_SYMBOL="ஃ"}"
SPACESHIP_JULIA_PREFIX="${SPACESHIP_JULIA_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_JULIA_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
