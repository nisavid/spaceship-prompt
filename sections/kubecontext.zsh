...
SPACESHIP_KUBECONTEXT_DIVIDER="${SPACESHIP_KUBECONTEXT_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_KUBECONTEXT_COLOR="${SPACESHIP_KUBECONTEXT_COLOR="cyan"}"
SPACESHIP_KUBECONTEXT_SYMBOL="${SPACESHIP_KUBECONTEXT_SYMBOL="☸️"}"
SPACESHIP_KUBECONTEXT_PREFIX="${SPACESHIP_KUBECONTEXT_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_KUBECONTEXT_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
