...
SPACESHIP_HG_STATUS_DIVIDER="${SPACESHIP_HG_STATUS_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_HG_STATUS_COLOR="${SPACESHIP_HG_STATUS_COLOR="red"}"
SPACESHIP_HG_STATUS_PREFIX="${SPACESHIP_HG_STATUS_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}["}"
...
SPACESHIP_HG_STATUS_SUFFIX="${SPACESHIP_HG_STATUS_SUFFIX="]${SPACESHIP_PROMPT_DEFAULT_SUFFIX}"}"
