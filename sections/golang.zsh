...
SPACESHIP_GOLANG_DIVIDER="${SPACESHIP_GOLANG_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_GOLANG_COLOR="${SPACESHIP_GOLANG_COLOR="cyan"}"
SPACESHIP_GOLANG_SYMBOL="${SPACESHIP_GOLANG_SYMBOL="🐹"}"
SPACESHIP_GOLANG_PREFIX="${SPACESHIP_GOLANG_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_GOLANG_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
