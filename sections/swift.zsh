...
SPACESHIP_SWIFT_DIVIDER="${SPACESHIP_SWIFT_DIVIDER="$SPACESHIP_PROMPT_DEFAULT_DIVIDER"}"
SPACESHIP_SWIFT_COLOR="${SPACESHIP_SWIFT_COLOR="yellow"}"
SPACESHIP_SWIFT_SYMBOL="${SPACESHIP_SWIFT_SYMBOL="🐦"}"
SPACESHIP_SWIFT_PREFIX="${SPACESHIP_SWIFT_PREFIX="${SPACESHIP_PROMPT_DEFAULT_PREFIX}${SPACESHIP_SWIFT_SYMBOL}${SPACESHIP_PROMPT_DEFAULT_PREFIX}"}"
